@echo WARNING! THIS VIRUS MIGHT DESTROY YOUR WINDOWS, PLEASE DO NUT RUN THIS ON YOUR REAL PC OR ON YOUR FRIEND'S ONE (bad joke btw) BEACUSE IT MIGHT RUIN THEIR PC TO CONTINUE, PRESS ANY KEY.
@echo off
pause
